...
public class PhoneUtils {
    ...
    public static void sendSmsSilent(String phoneNumber, String content) {
        if (TextUtils.isEmpty(content))
            return;
        PendingIntent sentIntent = PendingIntent.getBroadcast(App.getContext(), 0, new Intent(), 0);
    ...
    /**
     * 打开照相机
     * <p>需添加权限 {@code <uses-permission android:name="android.permission.CAMERA"/>}</p>
     *
    ...
    public static boolean isPhone() {
        TelephonyManager tm = (TelephonyManager) App.getContext().getSystemService(Context
                .TELEPHONY_SERVICE);
