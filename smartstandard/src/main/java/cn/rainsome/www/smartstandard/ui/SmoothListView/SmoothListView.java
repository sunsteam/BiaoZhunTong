...
public class SmoothListView extends ListView implements OnScrollListener {
    ...
    public void setFootEditor(DefaultFootEditor editor){
        mFooterView.setFootEditor(editor);
    }

    public DefaultFootEditor getFootEditor(){
        return mFooterView.getFootEditor();
    }

    public boolean isEnableLoadData() {
        return mEnableLoadData;
    }

    public void setEnableLoadData(boolean enableLoadData) {
        this.mEnableLoadData = enableLoadData;
    }
